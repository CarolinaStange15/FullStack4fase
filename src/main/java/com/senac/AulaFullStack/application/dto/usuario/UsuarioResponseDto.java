...
public record UsuarioResponseDto(Long id, String nome, String cpf, String email,String telefone, Long ongId) {

    public UsuarioResponseDto(Usuario usuario){
        this(
                usuario.getId(), usuario.getNome(), usuario.getCpf(), usuario.getEmail() , usuario.getTelefone(),
