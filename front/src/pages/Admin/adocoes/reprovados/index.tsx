...
import { buscarMeusPedidos, buscarPendentesPorOng, buscarReprovadosPorOng, cancelarRespostaAdocao, type PedidoAdocaoResponse } from "../../../../services/adocaoService";
import { useSelector } from "react-redux";
import type { RootState } from "../../../../redux/store";
import { useNavigate } from "react-router-dom";

export default function AdocoesReprovados() {
 ...
 const navigate = useNavigate();
  ...
  if (pedidos.length === 0) {
    return (
      <main className="container my-5 text-center">
        <h3 className="fw-bold">Pedidos de adoção reprovados</h3>
        <p className="text-muted mt-3">
          Sua ong não possui nenhum pedido de adoção reprovado.
        </p>
      </main>
    );
  }
  ...
  return (
    <main className="container my-5">
      <h3 className="mb-4 fw-bold">Pedidos de adoção reprovados</h3>
